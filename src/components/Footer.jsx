...
export default function Footer() {
    return (
      <header className="w-full h-20 bg-white border-solid border-t-2 border-black md:px-12">
        <div className="flex items-center justify-center w-full h-full text-4xl">
            find me:
            <button title="LinkedIn">
                <a href="">
                    <div className="flex items-center justify-center footer-icons mr-2 ml-4">
            ...
            <button title="Github">
                <a href="">
                    <div className="flex items-center justify-center footer-icons mr-2">
