export default function Header() {
  return (
      <header className="w-full h-20 bg-white flex items-center justify-between border-solid border-b-2 border-black md:px-12 sticky top-0 z-10">
          
          <div className="flex items-center border-r-2 border-black w-full h-20 text-5xl ml-96 border-l-2 ">
              <a href="/">nd</a>
          </div>
          
          <nav className="flex space-x-6 pr-12 text-3xl">
              <a href="/about" className="border-r-2 border-black w-80 h-20 flex items-center justify-center">
              ...
              <a href="/work" className=" border-r-2 border-black w-80 h-20 flex items-center justify-center">
                <div className="flex items-center justify-center header-icons mr-2">
              ...
              <a href="/contact" className="border-r-2 border-black w-80 h-20 flex items-center justify-center">
                <div className="flex items-center justify-center header-icons mr-2">
