...
export default function About() {
  return (
    <>
      ...
      {/* personal section */}
      <div className="personal w-full lg:h-96 flex flex-col justify-center lg:flex-row items-center lg:space-x-4">
      ...
      <div className="flex flex-col tech bg-white h-auto border-black border-t-2 items-center justify-center">
        <div className="flex flex-row w-full justify-center">
          ...
          <div className="flex border-black border-r-2 border-t-2 border-b-2 lg:w-3/6 w-4/6 bg-white lg:justify-center justify-evenly items-center text-center">
            <div className="flex-col flex h-full lg:pr-64 pr-6">
            ...
            <div className="flex h-full flex-col lg:pr-64 pr-2">
              <div className="flex-grow flex items-center">
                <div className="text-center pr-2">
                  <div className=" w-2 h-2 lg:w-5 lg:h-5 sm:h-2 sm:w-2 bg-yellow-400 about-icons "></div>
                </div>
